...
#SCEMILA_IMAGE_BASE_DS = SCEMILAimage_base(transforms_list=None,gpu=False)
SCEMILA_FEATURE_BASE_DS = SCEMILA_fnl34_feature_base(transforms_list=None,gpu=False)
#SCEMILA_DINO_BLOOM_BASE_DS = SCEMILA_DinoBloom_feature_base(transforms_list=None,gpu=False)
...
descriptors = []
dataset = SCEMILA_FEATURE_BASE_DS
